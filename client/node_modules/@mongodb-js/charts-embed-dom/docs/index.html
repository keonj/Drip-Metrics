		...
		<div class="tsd-panel tsd-typography">
			...
			<div align="center">
				...
				<div style="max-width:600px;width:100%">
					...
					<a href="https://codesandbox.io/s/github/mongodb-js/charts-embed-sdk/tree/master/examples/unauthenticated">Explore this example yourself!</a></p>
				</div>
			</div>
...
<span class="hljs-comment">// refresh the chart whenenver #refreshButton is clicked</span>
<span class="hljs-built_in">document</span>
  .getElementById(<span class="hljs-string">'refreshButton'</span>)
  .addEventListener(<span class="hljs-string">'click'</span>, () =&gt; chart.refresh());</code></pre>
...
<span class="hljs-builtin-name">export</span><span class="hljs-built_in"> default </span>{
  ...
  plugins: [ cjs(), resolve({ browser: <span class="hljs-literal">true</span>, preferBuiltins: <span class="hljs-literal">false</span> }) ]
			...
			<a href="#constructoroptions-embedchartoptions-chartsembedsdk" id="constructoroptions-embedchartoptions-chartsembedsdk" style="color: inherit; text-decoration: none;">
				<h4><code>constructor(options: EmbedChartOptions): ChartsEmbedSDK</code></h4>
			</a>
			<p>Creates an SDK object that can create Chart instances. Accepts an <code>object</code> that contains any default options to set for all Charts created using this SDK instance.</p>
			...
			<table>
				...
				<tbody><tr>
					...
					<tr>
						<td>width</td>
						<td>string | number</td>
						<td>The width of the embedded chart. If no width is provided, it will default to stretching to the width of it&#39;s container. If a value is provided without units, it will be assumed to be pixels (px).</td>
					</tr>
					<tr>
						<td>height</td>
						<td>string | number</td>
						<td>The height of the embedded chart. If no height is provided, it will default to stretching to the height of it&#39;s container. If a value is provided without units, it will be assumed to be pixels (px).</td>
					</tr>
					<tr>
						<td>autoRefresh</td>
						<td>boolean</td>
						<td>Specifies whether the chart automatically refreshes. If omitted, charts do not automatically refresh. Use this option with the maxDataAge option to configure how often the chart refreshes.</td>
					</tr>
					<tr>
						<td>maxDataAge</td>
						<td>number</td>
					...
					<tr>
						<td>filter</td>
						<td>object</td>
						<td>A filter to apply to the embedded chart. This expects an object that contains a valid <a href="https://docs.mongodb.com/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog for each Chart you wish to filter on.</td>
					</tr>
					<tr>
						<td>getUserToken</td>
						<td>function</td>
						<td>A function that shoud return a valid JWT token to use for authenticating the render request.</td>
					</tr>
					<tr>
						<td>theme</td>
						<td>&#39;light&#39; | &#39;dark&#39;</td>
						<td>The color scheme to apply to the chart. If the theme is set to &#39;dark&#39;, you will need to ensure that your background color has appropriate contrast as by default a chart&#39;s background is transparent.</td>
					</tr>
					<tr>
			...
			<p>Renders a chart into the specified container and should only be invoked once. It returns a Promise that will resolve once the chart is &#39;ready&#39; to accepts commands (like <code>setFilter</code>, <code>refresh</code>).</p>
			...
			<p>Enable or disable chart autorefresh. Auto refresh is disabled by default.</p>
			...
			<p>Applies a filter to the embedded chart. This expects an object that contains valid <a href="https://docs.mongodb.com/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog. An empty document <code>{}</code> is equivilent to no filter.</p>
			...
			<p>Sets a highlight to apply to an embedded chart. The <code>value</code> object parameter should contain valid <a href="https://docs.mongodb.com/manual/reference/operator/query/#query-selectors">query operators</a>. It is the same type of object that can be used in <code>setFilter</code>. You can clear an existing highlight by setting the <code>value</code> to an empty object <code>{}</code>.</p>
			...
			<a href="#getrealmusertokenclient-stitchclient-string" id="getrealmusertokenclient-stitchclient-string" style="color: inherit; text-decoration: none;">
				<h3>getRealmUserToken(client: StitchClient): string</h3>
			</a>
			<p>A helper function to use the Realm authentication provider.
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-function">
				...
				<ul class="tsd-signatures tsd-kind-function">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Realm<wbr>User<wbr>Token<span class="tsd-signature-symbol">(</span>stitchAppClient<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StitchAppClient</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>A helper utility to support using <a href="https://docs.mongodb.com/stitch/">Realm Authentication</a> with MongoDB Charts</p>
							</div>
...
<span class="hljs-keyword">const</span> sdk = <span class="hljs-keyword">new</span> ChartsEmbedSDK({
  <span class="hljs-attr">getUserToken</span>: <span class="hljs-function"><span class="hljs-params">()</span> =&gt;</span> getRealmUserToken(client)
						...
						<ul class="tsd-parameters">
							<li>
								<h5>stitchAppClient: <span class="tsd-signature-type">StitchAppClient</span></h5>
							</li>
						</ul>
