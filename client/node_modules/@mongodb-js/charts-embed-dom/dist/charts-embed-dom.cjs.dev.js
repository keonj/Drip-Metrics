...
class Chart {
  ...
  async render(container) {
    ...
    const host = chatty.Chatty.createHost(chartUrl).withSandboxAttribute('allow-scripts').withSandboxAttribute('allow-same-origin').withSandboxAttribute('allow-popups').withSandboxAttribute('allow-popups-to-escape-sandbox').appendTo(embedRoot).on('refreshToken', () => this.retrieveAndSetToken()).on('event', (event, payload, handlerIds) => {
      const handlers = this.eventHandlers[event];
